    ...
    <AnimatePresence mode="popLayout">
      ...
      >
        ...
        <button
          ...
          className="absolute right-24 opacity-0 lg:group-hover:opacity-100 transition-all duration-200 p-2 rounded-xl hover:bg-white/10 text-[var(--muted)] hover:text-[var(--text)]"
        >
